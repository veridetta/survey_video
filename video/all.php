...
<body>
    <?php 
        ...
        $judul="Menampilkan semua video";
        $su=mysqli_query($connect,"select * from video ");
        ...
        if($btn_cari){
            ...
            if($kategori=='all'){
                ...
                $su=mysqli_query($connect,"select * from video where judul like '%$kunci%'");
            }else{
                $judul="Menampilkan hasil pencarian ".$kunci;
                $su=mysqli_query($connect,"select * from video where kategori_id='$kategori' and judul like '%$kunci%'");
            }
        }
    ...
    <div class="col-12 row m-0 justify-content-center">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select name="kategori" class="form-control">
                                ...
                                <?php $ka=mysqli_query($connect, "select * from video_kategori order by nama");
        ...
        <?php 
         if($hitung<1){
            ...
            while($video=mysqli_fetch_array($su)){
                ?>

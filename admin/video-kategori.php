...
<style>
  ...
  if($btn_tambah){
        ...
        $show=" show";
        $insert=mysqli_query($connect, "insert into video_kategori (nama) values('$nama')");
          if($insert){
    ...
    if ($btn_ubah){
        ...
        $show=" show";
        $insert=mysqli_query($connect, "update video_kategori set nama='$nama' where id='$urutan'");
          if($insert){
    ...
    if ($btn_hapus){
        $urutan=mysqli_escape_string($connect, $_POST['urutan']);
        $show=" show";
        $insert=mysqli_query($connect, "delete from video_kategori where id='$urutan'");
          if($insert){
    ...
    <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a class="dropdown-item active" href="video-kategori.php"><i class="fa fa-edit"></i> Kategori</a></li>
        </ul>
      </li>
      <?php
        error_reporting(error_reporting() & ~E_NOTICE);
  ...
  <div class="col-11 col-lg-11 col-xs-12 col-md-11 col-sm-11 col-xl-11 mt-2">
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-body" >
                    <?php $lis=mysqli_query($connect, "Select * from video_kategori");
                    $o=0;
                        ...
                        <div class="col-xl-8 col-lg-8 col-sm-12 col-md-12 pt-2">
                                      <div class="form-group">
                                        <div class="input-group mb-1">
                                          ...
                                          <input type="text" class="form-control" name="nama" placeholder="Judul kategori max 30 char" aria-label="Username" aria-describedby="basic-addon1" maxlength="30" value="<?php echo $list['nama'];?>">
                                        </div>
                                      </div>
                                    </div>
